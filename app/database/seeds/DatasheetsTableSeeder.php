...
class DatasheetsTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$fields = array(
			...
			array('nampe' => 'Air Temperature', 'type' => 'radio', 'category_id' => 1, 'created_at' => $now, 'updated_at' => $now),
			...
			array('name' => 'On-Shore Recreation', 'type' => 'number', 'category_id' => 2, 'created_at' => $now, 'updated_at' => $now),
			...
			array('name' => 'Off-Shore Recreation', 'type' => 'number', 'category_id' => 3, 'created_at' => $now, 'updated_at' => $now),
